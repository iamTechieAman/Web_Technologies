...
import { CheckCircle2, Circle, BookOpen, Code2, Eye, Zap, Trophy } from 'lucide-react';
...
const PHASES = [
  ...
  { id: 2, title: 'Code', desc: 'Write clean, readable code. Handle edge cases.', icon: <Code2 size={16} />, color: 'text-cyan-400', bg: 'bg-cyan-500/10', border: 'border-cyan-500/20' },
              ...
              <div className={cn(
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {isActive && <span className="text-[8px] font-black uppercase bg-cyan-500/20 text-cyan-400 px-1.5 py-0.5 rounded animate-pulse">Current</span>}
                  </div>
